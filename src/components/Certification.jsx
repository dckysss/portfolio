  ...
  return (
    <section className="flex-1 flex-col text-center">
      ...
      <div className={`${layout.sectionImg} flex-row flex-wrap gap-8`}>
        {certs.map((cert) => (
          <div key={cert.id} className="w-[90%] md:min-h-[200px] relative shadow-md shadow-sky-500/50 border-2 border-neutral-200/80 rounded-[0.5rem] overflow-hidden img-transition md:w-[35%]">
